  ...
  return (
    <>
      <nav className="w-full flex justify-around md:justify-between items-center py-3 overflow-hidden">
        <div className="md:hidden w-8 h-8 flex items-center justify-center border border-white rounded-full text-white">
          <AiOutlinePlus />
        </div>
        <motion.div
        ...
        >
          ...
          <h2 className="text-white text-sm mt-1 hidden md:block 2xl:text-lg">
            + AGREGAR PELÍCULA
          </h2>
        </motion.div>
        <motion.div
        ...
        >
          ...
          >
            <div className="w-[24px] h-[2px] bg-white 2xl:w-[32px] 2xl:h-[3px]"></div>
            <div className="w-[24px] h-[2px] bg-white 2xl:w-[32px] 2xl:h-[3px]"></div>
            <div className="w-[24px] h-[2px] bg-white 2xl:w-[32px] 2xl:h-[3px]"></div>
          </div>
